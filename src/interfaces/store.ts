...
export type StoreType<SomeStore extends AnyStore> = SomeStore extends AnyStore<infer Type> ? Type : never
export type StoresType<SomeStores extends AnyStores> = {
    [Name in keyof SomeStores]: StoreType<SomeStores[Name]>
}

export type StoreActionType<SomeStore extends AnyStore> = SomeStore extends Store<any>
    ? ReturnType<SomeStore['action']>
    : never
export type StoresActionType<SomeStores extends AnyStores> = {
    [Name in keyof SomeStores]: StoreActionType<SomeStores[Name]>
}
export type StoresActions<SomeStores extends AnyStores> = Pick<StoresActionType<SomeStores>, KeysOfStores<SomeStores>>
